...
namespace WebBrowserSuper
{
    public class SecurityManagerCOM
    {
        ...
        public interface IProfferService
        {
            [return: MarshalAs(UnmanagedType.I4)]
            [PreserveSig]
            int ProfferService(ref Guid guidService, SecurityManagerCOM.IServiceProviderForIInternetSecurityManager psp, ref int cookie);
        ...
        public interface IServiceProviderForIInternetSecurityManager
        {
            [return: MarshalAs(UnmanagedType.I4)]
            [PreserveSig]
            int QueryService(ref Guid guidService, ref Guid riid, [MarshalAs(UnmanagedType.Interface)] out SecurityManagerCOM.IInternetSecurityManager ppvObject);
        }
